...
urlpatterns = [
    ...
    path('apis/user/getotherinfo', views.getOtherInfo),#获取他人信息
    path('apis/user/dismissTeam', views.dismissTeam),#解散团队
    path('apis/user/getTeamInformation', views.getTeamInformation),#获得团队所有信息
